...
const username = "marjoleinkeltjens";
// Selects the unordered list to display the repo list
const repoList = document.querySelector(".repo-list");
//Selects the section where all your repo information appears
const allRepoData = document.querySelector(".repos");
// Selects the section where the individual repo data will appear
